...
from .views.personal_settings import PersonalSettingsRetrieveUpdateDestroy
...
urlpatterns = [
    ...
    path(r'personal_settings/<int:pk>', PersonalSettingsRetrieveUpdateDestroy.as_view())
]
